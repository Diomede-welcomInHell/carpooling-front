...
import { addProfil } from "@/lib/profil";

export default function FormProfil() {

    const [state, formAction, isLoading] = useActionState(addProfil, null);
            ...
            <Form action={formAction} className="p-2">
                <div className="flex flex-col gap-4">
                    ...
                    <TextField className="w-full max-w-64" name="firstname">
                        <Label>Prénom</Label>
                        <Input placeholder="Entrer votre prénom" type="text" value={state?.firstname}/>
                    </TextField>
                    <TextField className="w-full max-w-64" name="lastname">
                        <Label>Nom</Label>
                        <Input placeholder="Entrer votre nom" type="text" value={state?.lastname}/>
                    </TextField>
                    <TextField name="phone" type="tel">
                        <Label>Téléphone</Label>
                        <Input placeholder="06 00 00 00 00" value={state?.phone}/>
                    </TextField>
                </div>
                {state?.error && (
